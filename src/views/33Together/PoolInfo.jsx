      ...
      <Paper className="fan-card">
          ...
          <>
            <Box display="flex" flexDirection="column" className="user-pool-data">
              ...
              <div className="data-row">
                ...
                <Typography>{props.isAccountLoading ? <Skeleton width={100} /> : props.sfanBalance} sFAN</Typography>
              </div>
            </Box>
        ...
        <Box display="flex" flexDirection="column" className="pool-data">
          ...
          <div className="data-row">
            ...
            <Typography>
              {props.graphLoading ? <Skeleton width={100} /> : props.totalDeposits.toLocaleString()} sFAN
            </Typography>
          </div>
          <div className="data-row">
            <Typography>
            ...
            <Typography>
              {props.graphLoading ? <Skeleton width={100} /> : props.totalSponsorship.toLocaleString()} sFAN
            </Typography>
          </div>
          <div className="data-row">
            <Typography>
